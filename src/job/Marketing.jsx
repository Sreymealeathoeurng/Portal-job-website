...
const Marketing = () => {
    ...
    const fetchJobListings = () => {
        setLoading(true);
        try {
            const marketingCategory = data.Joblisting.find(category => category.category === "Marketing");
            setJobListings(marketingCategory ? marketingCategory.job : []);
        } catch (error) {
            ...
            <div className="job-list-container">
                ...
                <div className="jobCategories" id="jobCategories">
                    {jobListings.length > 0 ? (
                        ...
                        <p>No job listings available for Marketing.</p>
                    )}
                </div>
                <div className="link-to-accounting">
                    <Link to="/accounting" className="accounting-link">View Accounting Job Listings</Link>
                </div>
            </div>
        </div>
    );
