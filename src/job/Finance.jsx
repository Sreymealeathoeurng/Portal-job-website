...
const Finance = () => {
    ...
    const [visibleJobId, setVisibleJobId] = useState(null); // State to manage visible job details
    ...
    const fetchJobListings = async () => {
        ...
        try {
            ...
            const financeJobs = data.find(category => category.category === "Finance");
            setJobListings(financeJobs ? financeJobs.job : []);
        } catch (error) {
    ...
    return (
        <div className="accounting-main">
            <div className="scrollable-container">
                <h1 className="job-title">Finance Job Listings</h1>
                {loading && <p>Loading...</p>}
                {error && (
                    <div>
                ...
                <div className="jobCategories">
                    {jobListings.length > 0 ? (
                        ...
                        !loading && <p>No job listings available for Finance.</p>
                    )}
                </div>
            </div>
        </div>
