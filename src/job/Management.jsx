...
const Management = () => {
    ...
    const fetchJobListings = () => {
        setLoading(true);
        try {
            const managementCategory = data.Joblisting.find(category => category.category === "Management");
            setJobListings(managementCategory ? managementCategory.job : []);
        } catch (error) {
    ...
    return (
        <div className="main">
            <div className="scrollable-container">
                <h1 className="job-title">Management Job Listings</h1>
                {loading && <p>Loading...</p>}
                {error && (
                    <div>
                ...
                <div className="jobCategories">
                    {jobListings.length > 0 ? (
                        ...
                        !loading && <p>No job listings available for Management.</p>
                    )}
                </div>
            </div>
        </div>
