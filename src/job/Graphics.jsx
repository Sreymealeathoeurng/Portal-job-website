...
const Graphics = () => {
    ...
    const fetchJobListings = () => {
        setLoading(true);
        try {
            const graphicCategory = data.Joblisting.find(category => category.category === "Graphics");
            setJobListings(graphicCategory ? graphicCategory.job : []);
        } catch (error) {
    ...
    return (
        <div className="main">
            <div className="scrollable-container">
                <h1 className="job-title">Graphics Job Listings</h1>
                {loading && <p>Loading...</p>}
                {error && (
                    <div>
                ...
                <div className="jobCategories">
                    {jobListings.length > 0 ? (
                        ...
                        !loading && <p>No job listings available for Graphics.</p>
                    )}
                </div>
            </div>
        </div>
